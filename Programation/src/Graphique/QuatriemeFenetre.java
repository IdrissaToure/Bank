...
import static Graphique.ConnectionDB.con;
 ...
 * @author hp
 */
public class QuatriemeFenetre extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuatriemeFenetre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuatriemeFenetre().setVisible(true);
            }
        });
    }
