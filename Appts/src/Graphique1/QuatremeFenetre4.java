...
import Graphique1.ConnectionDB;
import static Graphique1.ConnectionDB.con;
 ...
 * @author hp
 */
public class QuatremeFenetre4 extends javax.swing.JFrame {
        private PreparedStatement ps;
        private ResultSet Resultat;
        
    /**
     * Creates new form QuatriemeFenetre
     */
    public QuatremeFenetre4() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Prénom", "Nom", "ID", "Age" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuatremeFenetre4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuatremeFenetre4().setVisible(true);
            }
        });
    }
    ...
    private void afficheClient() {
        try {
         ...
         //Mettre le résultat sur le tableau jTable1 grâce à la librairie re2xml
         jTable1.setModel(DbUtils.resultSetToTableModel(Resultat));
         jLabel5.setText(jTable1.getRowCount()+"Client");
        } catch (Exception e) {
        }
    }
}
